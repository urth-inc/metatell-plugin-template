...
export const App: React.FC = () => {
	...
	const [loggedInButtonText, setLoggedInButtonText] =
		useState("トップページへ戻る");
	const [loggedInButtonUrl, setLoggedInButtonUrl] = useState(
		"https://example.com",
	);
	const [anonymousMessage, setAnonymousMessage] = useState(
		"このルームへの入室は制限されています",
	);
	const [anonymousButtonText, setAnonymousButtonText] =
		useState("ログインする");
	const [anonymousButtonUrl, setAnonymousButtonUrl] = useState(
					...
					<div className={styles.panelGrid}>
						<label className={styles.field}>
							...
							<select
								value={reason}
								onChange={(event) =>
									setReason(event.target.value as ExitReasonType)
								}
							>
						...
						<div className={styles.fieldGroup}>
							...
							<label className={styles.field}>
								...
								<input
									...
									onChange={(event) =>
										setLoggedInButtonText(event.target.value)
									}
								/>
							</label>
							<label className={styles.field}>
						...
						<div className={styles.fieldGroup}>
							...
							<label className={styles.field}>
								...
								<input
									...
									onChange={(event) =>
										setAnonymousButtonText(event.target.value)
									}
								/>
							</label>
							<label className={styles.field}>
								...
								<input
									...
									onChange={(event) =>
										setAnonymousButtonUrl(event.target.value)
									}
								/>
							</label>
						</div>
